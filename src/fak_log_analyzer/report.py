"""Terminal reporting functionality for FAK Log Analyzer."""
...
def print_report(result: AnalysisResult) -> None:
    """Display an analysis report in the terminal."""
    ...
    for ip, count in result.ip_counts.most_common(10):
    ...
    for path, count in result.path_counts.most_common(10):
